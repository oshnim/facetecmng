...
public class tutor_science extends AppCompatActivity {

    private Button tutor_science_btn2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_science);

        tutor_science_btn2 = findViewById(R.id.tutor_science_btn2);
        tutor_science_btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(tutor_science.this, tutor_dashboard.class);
